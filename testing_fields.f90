...
sim%Bmagne = vector(1.0_d,0.0_d,0.0_d)
...
antiproton%Felec = antiproton%q*(antiproton%Eelec + cross_product(antiproton%mom/antiproton%mass, sim%Bmagne))
...
CALL graph_energy(antiproton, t, sim%pos2, proton%q)
