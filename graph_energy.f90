SUBROUTINE eKU(a,b)
  ...
  !-------------------------------------------
  REAL(d)::Ki,U !aceleración, radio, energía cinetica y potencial respectivamente
 ...
 !! a%vel=a%mom/a%mass !velocidad de la partícula
  ...
  U=a%mass*ac*sim%pos2 !!cambiar esto, por esta formula https://en.wikipedia.org/wiki/Electric_potential_energy
